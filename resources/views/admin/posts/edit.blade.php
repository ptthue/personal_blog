                ...
                <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6">
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-textarea-input id="content" name="content" placeholder="Enter content"
                                                  class="w-full" value="{{ $post->content }}">{{ $post->content }}</x-textarea-input>
                                <x-input-error :messages="$errors->get('post')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="category_id" value="Category" />
                                <x-select-input id="category_id" name="category_id" placeholder="Enter category"
                            ...
                            <div>
                                ...
                                <x-file-input id="image" name="image" type="file" placeholder="Enter image"
                                              class="w-full" :value="$post->image_path" />
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex justify-end space-x-3">
                            ...
                            <x-primary-button type="primary" tag="button" buttonType="submit">
                                Update Post
                            </x-primary-button>
                        </div>
                    </div>
